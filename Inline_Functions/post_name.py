...
Send.Inline_Keyboard(Bot_Variables, "Text Here" ,
    ...
    Send.Message(Bot_Variables, "שלח כאן את מי שברצונך לקרוא תהילים לשמו, לדוגמא פלוני בן פלוני")

    Users.update_one({"chat_id": Chat_ID}, {"$set": {"virtual_location" : "post_name"}})
