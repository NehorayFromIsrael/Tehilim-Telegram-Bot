...
#Markup synatx
    Send.Keyboard(Bot_Variables, "איזור אישי 🙎‍♂️",
                  Button.Markup("פרסם קריאה משותפת לשם מישהו 🙏️"),
                  Button.Markup("מועדפים ⭐️"),
                  Button.Markup("סטטיסטיקה אישית📊","הגדרות ⚙️"),
                  Button.Markup("חזור ↩️")
             )
