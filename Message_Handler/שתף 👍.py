...
Send.Inline_Keyboard(Bot_Variables, "Text Here" ,
    ...
    text = "אני מזמין אותך להיכנס לבוט התהילים של טלגרם😇🌀"

    url = url.format(urllib.parse.quote(text + "\n https://t.me/Tehilim_Book_bot"))





    Send.Inline_Keyboard(Bot_Variables, "שלח לחבר את בוט התהילים 🌀" ,
                         Button.Inline(  ["U","לחץ לשיתוף 👍",url] )
