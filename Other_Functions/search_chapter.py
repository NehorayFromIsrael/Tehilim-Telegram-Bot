...
Send.Inline_Keyboard(Bot_Variables, "Text Here" ,
    ...
    except:chapter = gematria_to_int(chapter)
    chapter = chapter - 1
    ...
    if chapter >-1 and chapter < 151:
        ...
        Users.update_one({"chat_id": Chat_ID}, {"$set": {"book.bookmark": chapter}})

        Send.Inline_Keyboard(Bot_Variables, Send_Book.Func(chapter, Bot_Variables),
        ...
        Send.Message(Bot_Variables, '❌ חיפוש שגוי, מספר הפרקים בתהילים הוא 150 , ניתן לחפש בטווח 1 - 150 א - ק"נ ❌')